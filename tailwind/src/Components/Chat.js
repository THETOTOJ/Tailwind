...
export default function Chat() {
    ...
    <>
    <div>
    <div class='search bg-gray-50 content'>
    ...
    <div class=" container content bg-slate-500	 flex items-start border rounded lg:grid lg:grid-cols-3">
        <div class="users bg-gray-50 border-r border-gray-300 lg:col-span-1">
            <ul class="overflow-auto h-[32rem]">
                    ...
                    <a
                        ...
                        <img class="object-cover w-10 h-10 rounded-full"
                            ...
                            <a
                                ...
                                <div class="w-full pb-2">
                                    <div class="flex justify-between">
                                        <span class="block ml-2 font-semibold text-gray-600">Lindsey Stroud</span>
                ...
                <div class="chat bg-gray-50 hidden lg:col-span-2 lg:block">
                    <div class="w-full">
                        <div class="relative flex items-center p-3 border-b border-gray-300">
                            <img class="object-cover w-10 h-10 rounded-full"
                                src="https://cdn.pixabay.com/photo/2018/01/15/07/51/woman-3083383__340.jpg" alt="username" />
                            <span class="block ml-2 font-bold text-gray-600">Lindsey Stroud</span>
